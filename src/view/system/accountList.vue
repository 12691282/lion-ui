    ...
    <Modal  draggable scrollable v-model="isDisplay" :style="{top: '20px'}" :mask-closable="false">
        ...
        <Form ref="accountModel" :model="accountModel" :label-width="80" :rules="accountModelRules">
            <FormItem label="名字" prop="name">
                <Input type="text" v-model="accountModel.name" maxlength="10" show-word-limit  placeholder="请输入名字" />
            </FormItem>
            <FormItem label="账号名" prop="accountName">
                <Input type="text" v-model="accountModel.accountName" maxlength="18" show-word-limit  placeholder="请输入账号名" />
            </FormItem>
            <FormItem label="密码" prop="password">
                <Input type="password" v-model="accountModel.password" maxlength="24"  password placeholder="请输入密码" />
            </FormItem>
            <FormItem label="确认密码" prop="confirmPassword">
                <Input type="password" v-model="accountModel.confirmPassword" maxlength="24" password placeholder="请输入确认密码" />
            </FormItem>
            <FormItem label="E-mail" prop="email">
                <Input type="text" v-model="accountModel.email"  maxlength="30" show-word-limit placeholder="请输入e-mail" />
            </FormItem>
            <FormItem label="备注" prop="backup">
                <Input type="textarea" v-model="accountModel.backup" :rows="2"   maxlength="50" show-word-limit placeholder="请输入备注" />
            </FormItem>
        </Form>
        <div slot="footer">
